    ...
    return (<section
        ...
        <div className="max-w-[1100px]">
            ...
            <p className="text-justify mb-4">The International Conference on Next-Generation Networks and Deployable
                ...
                (NGNDAI-2026) is a platform that brings together researchers, industry experts, and practitioners to
                explore
                ...
                from
                around the world. The scopes of NGNDAI-2026 include the following themes (but not limited to):
            </p>
