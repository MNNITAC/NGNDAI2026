...
const Navbar = () => {
  const navItems = [
    ...
    },
    {
      ...
      link: "/committee",
      sublinks: [
        { name: "Organising Committee", link: "/committee" },
        {
          name: "International Advisory Committee",
          link: "advisoryCommittee#International%20Advisory%20Committee",
        },
        {
          name: "National Advisory Committee",
          link: "advisoryCommittee#National%20Advisory%20Committee",
        },
        {
  ...
  return (
    ...
    >
      <div className="flex w-full justify-between md:justify-start px-4 max-w-[1400px] items-center">
        ...
        >
          {navItems.map((el) => (
            <Dropdown key={el.link} el={el} prevPath={el.prevPath || ""} />
          ))}
        </div>
        <Accessability />
      </div>
