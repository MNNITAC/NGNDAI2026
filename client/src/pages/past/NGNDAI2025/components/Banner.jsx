        ...
        <div
            ...
            <div className="flex md:flex-row flex-col text-xl justify-center items-center align-middle gap-5 mt-4">
                ...
                <div onClick={() => window.open(schedule, "_blank")}
                    ...
                    Conference Schedule
                    <GrDocumentPdf />
                    <div className="animate-ping bg-yellow-400 text-red-600 rounded-full absolute -top-3 -right-3 w-[20px] h-[20px]"></div>
                </div>
