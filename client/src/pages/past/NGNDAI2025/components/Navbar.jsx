...
const Navbar = () => {
    ...
    const navItems = [{
        ...
        sublinks: [{name: "About Conference", link: "/#about%20conference"}, {
        ...
        name: "Conference Program", link: "/schedule", sublinks: [{name: "Timeline", link: "/schedule"}
            , {
            ...
            }, {name: "Accomodation", link: "accomodationPage"}, {name: "Cultural Program", link: "culturalProgramPage"}]
    }, {
        ...
        <div className="flex w-full justify-between md:justify-start px-4 max-w-[1400px] items-center">
            <div className="flex items-center gap-4 p-1">
                ...
                <p className="font-extrabol flex justify-center items-center align-middle flex-col font-playfair">
                    <span>NGNDAI</span><span>  2025</span></p>
            </div>
