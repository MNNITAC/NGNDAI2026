    ...
    return (<section id="about conference"
        ...
        <div className="max-w-[1100px]">
            ...
            <div className="grid w-full grid-cols-1 items-center justify-start gap-8 lg:grid-cols-[2fr_1fr]">
                <div className="text-justify text-base font-normal *:mb-3">
                    <p><span className="font-medium">The International Conference on Next-Generation Networks and Deployable Artificial
                        Intelligence (NGNDAI-2025)</span> is a platform that brings together researchers, industry
                        experts,
                        and practitioners to explore cutting-edge developments in <span className="font-medium"> machine intelligence,
                        communication systems, and related technologies.</span> NGNDAI-2025 features diverse topics
                        ...
                        focus
                        on future technologies, NGNDAI-2025 is poised to advance the state-of-the-art in
                        intelligent
            ...
            <div className="mt-1 text-justify">
                ...
                <div>
                    <p className="font-medium">The scope of NGNDAI-2025 covers the following themes but not
                        be limited to:</p>
